...
export default function DesignPage() {
  return (
    <div className="min-h-screen bg-background p-8 space-y-16">
      ...
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-foreground">Jimmy's Cafe — Design System</h1>
        <p className="text-muted-foreground mt-1">Component showcase and visual reference</p>
      </div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { name: 'Background', hex: '#FDFBF2', cls: 'bg-background border border-border' },
            ...
            { name: 'Muted', hex: '#F0EDD8', cls: 'bg-muted border border-border' },
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-baseline gap-4">
            <span className="text-xs text-muted-foreground w-24 shrink-0">Page Title</span>
            <p className="text-2xl font-bold">Jimmy's Cafe Dashboard</p>
          </div>
          <div className="flex items-baseline gap-4">
            <span className="text-xs text-muted-foreground w-24 shrink-0">Section</span>
            <p className="text-lg font-semibold">Featured Items</p>
          </div>
          <div className="flex items-baseline gap-4">
            <span className="text-xs text-muted-foreground w-24 shrink-0">Body</span>
            <p className="text-sm">Ultimate breakfast burrito with eggs, cheese, and salsa</p>
          </div>
          <div className="flex items-baseline gap-4">
          ...
          <div className="flex items-baseline gap-4">
            <span className="text-xs text-muted-foreground w-24 shrink-0">Caption</span>
            <p className="text-xs text-muted-foreground">Today at 9:41 AM</p>
          </div>
          <div className="flex items-baseline gap-4">
            <span className="text-xs text-muted-foreground w-24 shrink-0">Price</span>
            <p className="text-xl font-bold">$12.99</p>
          </div>
          <div className="flex items-baseline gap-4">
            <span className="text-xs text-muted-foreground w-24 shrink-0">Order #</span>
      ...
      <section className="space-y-4">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          ...
          <Button size="icon" className="bg-accent text-accent-foreground rounded-full">
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Badge className="bg-blue-100 text-blue-800 border-blue-200">CONFIRMED</Badge>
            <Badge className="bg-orange-100 text-orange-800 border-orange-200">PREPARING</Badge>
            ...
            <Badge className="bg-purple-100 text-purple-800 border-purple-200">REFUNDED</Badge>
          </div>
        </div>
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            { label: 'Pending Orders', value: '12', icon: ClipboardList, color: 'text-amber-500' },
            { label: 'Completed Today', value: '48', icon: Package, color: 'text-green-500' },
            { label: 'Revenue Today', value: '$1,284', icon: TrendingUp, color: 'text-blue-500' },
            { label: 'Active Products', value: '36', icon: Star, color: 'text-accent' },
          ].map((stat) => (
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { name: 'Ultimate Breakfast Burrito', desc: 'Short on breakfast with ultimate breakfast burrito', price: '$12.99' },
            { name: 'Grilled Chicken Sandwich', desc: 'Grilled chicken sandwich with chicken and burrito', price: '$14.50' },
            { name: 'Classic Pancakes', desc: 'Fluffy buttermilk pancakes with maple syrup', price: '$9.99' },
            { name: 'Cafe Latte', desc: 'Espresso with steamed whole milk and light foam', price: '$5.50' },
          ].map((product) => (
            <Card key={product.name} className="overflow-hidden border-border p-0">
              ...
              <CardContent className="p-3">
                ...
                <p className="text-xs text-muted-foreground mt-1 line-clamp-2">{product.desc}</p>
      ...
      <section className="space-y-4">
        ...
        <div className="flex items-center gap-4">
          <Avatar className="w-12 h-12">
            <AvatarImage src="" />
            <AvatarFallback className="bg-primary text-primary-foreground font-semibold">JA</AvatarFallback>
          </Avatar>
          <Avatar className="w-12 h-12">
            <AvatarFallback className="bg-accent text-accent-foreground font-semibold">MR</AvatarFallback>
          </Avatar>
          <Avatar className="w-12 h-12">
            <AvatarFallback className="bg-muted text-muted-foreground font-semibold">TK</AvatarFallback>
          </Avatar>
      ...
      <section className="space-y-4">
        ...
        <Card className="border-border">
          <Table>
            ...
            <TableBody>
              {[
                { id: 'ORD-2026-0042', type: 'Dine In', customer: 'Jerome A.', status: 'PREPARING', statusCls: 'bg-orange-100 text-orange-800', total: '$34.50' },
                { id: 'ORD-2026-0041', type: 'Takeout', customer: 'Walk-in', status: 'READY', statusCls: 'bg-green-100 text-green-800', total: '$12.99' },
                { id: 'ORD-2026-0040', type: 'Delivery', customer: 'Maria R.', status: 'CONFIRMED', statusCls: 'bg-blue-100 text-blue-800', total: '$28.00' },
                { id: 'ORD-2026-0039', type: 'Dine In', customer: 'Tom K.', status: 'COMPLETED', statusCls: 'bg-gray-100 text-gray-700', total: '$19.75' },
                { id: 'ORD-2026-0038', type: 'Online', customer: 'Sara J.', status: 'PENDING', statusCls: 'bg-amber-100 text-amber-800', total: '$45.20' },
              ].map((order) => (
                <TableRow key={order.id} className="border-border">
                  ...
                  <TableCell>
                    <Badge className={`text-xs ${order.statusCls} border-0`}>{order.status}</Badge>
                  </TableCell>
